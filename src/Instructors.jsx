...
export default function Instructors() {
  return (
    ...
    <div className='bio-description-container'>
    <h1>Matt Kelley</h1>
    <p>Matt Kelley is a black belt under Brian Rago of Gracie Humaita Philadelphia. Matt has spent years training with and learning from some of the best Jiu Jitsu practitioners in the country. He is a loving father, husband, and devotes his life to helping others unlock their potential both on and off the mats. In addition to teaching at the Vault, Matt continues to teach every Sunday at 8 a.m. at Gracie Humaita Philadelphia.</p>
    
    <div className='accolades-list-container'>
    <ul>
        <li>Black Belt under Brain Rago from Gracie Humaita Philadelphia</li>
        <li>Lorem ipsum dolor sit amet consectetur</li>
        <li>Lorem ipsum dolor sit amet consectetur</li>
        <li>Lorem ipsum dolor sit amet consectetur</li>
    </ul>
    ...
    <p>"My Goal is to turn you into a weapon and a force for good! I want to unlock your potential on and off the mats!"</p>
    ...
    <div className='accolades-list-container'>
    <ul>
        <li>PhD In School Psychology from Philadelphai College Of Osteopathic Medicine (PCOM)</li>
    ...
    <p>"I love watching our students gain confidence, I love to be a part of every students jiu jitsu jounrney!"</p>
    ...
    <div className='accolades-list-container'>
    <ul>
        <li>Black Belt under Phil and Ricardo Migliarese from Balance Studios</li>
    ...
    <p>Favorite submission: Rear naked choke</p>
    <p>"Martial Arts is the best tool for maximizing your potential!"</p>
