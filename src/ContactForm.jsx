...
export default function ContactForm() {
  ...
  const handleSubmit = (e) => {
    ...
    axios
      .post("https://vault-jiu-jitsu-api.fly.dev/contact", formData)
      .then((response) => {
  ...
  return (
    <div className="contact-form-wrapper">
      <div className="contact-form-title-subtitle-container">
        <h1>
          VAULT JIU JITSU - YOUR CONVENIENT DELAWARE COUNTY BRAZILIAN JIU JITSU
          ACADEMY!
        </h1>
        <p>
          Located conveniently in Morton, Del PA close to I-95, The Blue Route
          476 and South Philadelphia and minutes away from Philadelphia, Glen
          Mills, Broomall and The Main Line
        </p>
        <p>
          Please don't hesitate to contact us! We cannot wait to be a part of
          your jiu jitsu and self-improvement journey!
        </p>
        <h3>Contact Us</h3>
      </div>
